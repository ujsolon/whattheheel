# YOUCAM API SKIN AI & APPAREL VTO HACKATHON (THE “HACKATHON”) OFFICIAL RULES
...
- **Registration Period:** Jul 1, 2026 (12:00 pm Eastern Time) – Aug 17, 2026 (11:45 am Eastern Time) (“Registration Period”).
- **Submission Period:** Jul 6, 2026 (12:00 pm Eastern Time) – Aug 17, 2026 (11:45 am Eastern Time) (“Submission Period”).
- **Judging Period:** Aug 18, 2026 (12:00 pm Eastern Time) – Aug 31, 2026 (11:45 am Eastern Time) (“Judging Period”).
- **Winners Announced:** On or around Sep 4, 2026 (3:00 pm Eastern Time).

(collectively “Hackathon Period”)

## 2. Sponsor and Administrator

Perfect Mobile Corp., 14F., No. 98, Minquan Rd., Xindian Dist., New Taipei City 231, Taiwan
...
- Individuals who are residents of, or Organizations domiciled in, a country, state, province or territory where the laws of the United States or local law prohibits participating or receiving a prize in the Hackathon (including, but not limited to, Afghanistan, Antarctica, China, Djibouti, Iraq, Somalia, Venezuela, Western Sahara, Italy, Brazil, Quebec, Russia, Cuba, Iran, and North Korea, Sudan, Belarus, Vietnam, the Crimea, Donetsk, and Luhansk regions of Ukraine, and any other country which is comprehensively sanctioned by the U.S. Treasury’s Office of Foreign Assets Control)
...
Entrants may enter by visiting YouCam-API.devpost.com (“Hackathon Website”) and following the below steps:
...
2.  Entrants will obtain access to the required developer tools/platform and complete a Project described below in Project Requirements. Use of the YouCam API will be subject to YouCam's Terms of Service and Perfect Corp.'s Terms of Service.. Entry in the Hackathon constitutes consent for the Sponsor and Devpost to collect and maintain an entrant’s personal information for the purpose of operating and publicizing the Hackathon.
3.  **Create a free YouCam Online Editor account** at `https://yce.perfectcorp.com/ai-api`.
4.  **Request a YouCam API redeem code**, which includes 1,000 free API units for use during the Hackathon, by submitting a request via this link: `https://yce.perfectcorp.com/ai-api?utm_source=event&utm_medium=YouCamAPIHackathon&utm_campaign=devpost&utm_content=skin&clothes`. Redeem codes are issued on a per-registrant basis, and are non-transferable, and are valid for 90 days from the date of redemption. To redeem your code, log in to your YouCam account and apply it in your account dashboard.
...
- **What to Create:** Entrants must create a working application that integrates at least one Perfect Corp. YouCam API from the Skin or Fashion category and demonstrate clear consumer or retail value (each a “Project”).
...
- Provide a URL to your code repository for judging and testing. The repository must contain all necessary source code, assets, and instructions required for the project to be functional. The repository must be either public (with relevant licensing) or private and shared with `contact_event@PerfectCorp.com`.
- Include a text description that must explain the features, functionality and demonstrate clear consumer or retail value of your Project.
- Include a 1-3-minute Demo video showing the experience end-to-end:
    - Judges are not required to watch beyond three minutes
    - must explain the YouCam API used in the submission
    - must include footage that shows the Project functioning on the device for which it was built
    - must be uploaded to and made publicly visible on YouTube (highly preferred), or Vimeo, and a link to the video must be provided on the submission form on the Hackathon Website; and
...
- **Technological Implementation:** How thoroughly and skillfully does the project integrate at least one Perfect Corp. YouCam API from the Skin or Fashion category? Does the project demonstrate clear consumer or retail value? Does the code reflect genuine effort and a working, non-trivial implementation?
...
- **Quality of the Idea:** Is this a creative, non-obvious use of at least one Perfect Corp. YouCam API from the Skin or Fashion category — and does the team demonstrate genuine understanding of the problem space they're working in?
...
All Submissions remain the intellectual property of the individuals or organizations that developed them. By submitting an entry, entrants agree that the Sponsor will have a non-exclusive license to use such entry for judging the entry. Entrants agree that the sponsor and Devpost shall have the right to promote the Submission and use the name, likeness, voice and image of all individuals contributing to a Submission, in any materials promoting or publicizing the Hackathon and its results, during the Hackathon Period and for three years thereafter. Some Submission components may be displayed to the public. Other Submission materials may be viewed by the sponsor, Devpost, and judges for screening and evaluation. By submitting an entry or accepting any prize, entrants represent and warrant that (a) submitted content is not infringing any third-party’s intellectual property right, protected by trade secret or otherwise subject to third party intellectual property rights or other proprietary rights, including privacy and publicity rights, unless entrant is the owner of such rights or has permission from their rightful owner to post the content; and (b) the content submitted does not contain any viruses, Trojan horses, worms, spyware or other disabling devices or harmful or malicious code.

## 8. Prizes

| Winner | Prize | Qty | Eligible Submissions | Judging Criteria |
| :--- | :--- | :--- | :--- | :--- |
| **1st Place** | $5000 in Cash<br>Blog post featuring the winning submissions<br>Meeting with the Product/Developer Marketing Team | 1 | All Eligible Submissions | All judging criteria |
| **2nd Place** | $1000 in Cash<br>Blog post featuring the winning submissions<br>Meeting with the Product/Developer Marketing Team | 1 | All Eligible Submissions | All judging criteria |
| **3rd Place** | 5,000 API Units per winner ($275 USD Value)<br>Blog post featuring the winning submissions<br>Meeting with the Product/Developer Marketing Team | 1 | All Eligible Submissions | All judging criteria |
| **4th Place** | 5,000 API Units per winner ($275 USD Value)<br>Blog post featuring the winning submissions<br>Meeting with the Product/Developer Marketing Team | 1 | All Eligible Submissions | All judging criteria |
| **5th Place** | 5,000 API Units per winner ($275 USD Value)<br>Blog post featuring the winning submissions<br>Meeting with the Product/Developer Marketing Team | 1 | All Eligible Submissions | All judging criteria |
